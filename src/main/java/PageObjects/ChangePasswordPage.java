...
public class ChangePasswordPage extends BasePage {
    ...
    /*
     * */
    protected WebElement getBoxCurentPassword() {
        return Constant.DRIVER.findElement(boxCurentPassword);
    }

    protected WebElement getBoxNewPassword() {
        return Constant.DRIVER.findElement(boxNewPassword);
    }
    ...
    protected WebElement getButtonChangePassword() {
        return Constant.DRIVER.findElement(buttonChangePassword);
    }
    ...
    /*
     * */
    public void enterCurentPassword(String currentPassword) {
        WebdriverUtils.waitTillVisible(getBoxCurentPassword(), Constant.SHORT_WAIT);
        getBoxCurentPassword().sendKeys(currentPassword);
    }

    public void enterNewPassword(String newPassword) {
        WebdriverUtils.waitTillVisible(getBoxNewPassword(), Constant.SHORT_WAIT);
        getBoxNewPassword().sendKeys(newPassword);
    }

    public void confirmPassword(String confirmPassword) {
        WebdriverUtils.waitTillVisible(getBoxConfirmPassword(), Constant.SHORT_WAIT);
        getBoxConfirmPassword().sendKeys(confirmPassword);
    }

    public void clickButtonChangePassword() {
        WebdriverUtils.scrollDowntoElement(getButtonChangePassword());
        WebdriverUtils.waitTillClickable(getButtonChangePassword(), Constant.SHORT_WAIT);
