...
public class TestCase15 extends TestBase {
    ...
    public void TC15(Object[]data) {
        Log.info("TC15-Read data");
        String departFrom= data[0].toString();
        String arriveAt= data[1].toString();
        Log.info("TC15-Login and check price");
        ...
        String[] expectedList = {data[2].toString(), data[3].toString(), data[4].toString(),
                data[5].toString(), data[6].toString(), data[7].toString()};
